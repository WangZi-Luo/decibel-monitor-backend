...
# ============ 路由映射 ============
ROUTES = {
    '/api/v1/monitor/start': api_monitor_start,
    '/api/v1/monitor/stop': api_monitor_stop,
    '/api/v1/status': api_get_status,
    '/api/v1/video/start': api_video_start,
    '/api/v1/video/stop': api_video_stop,
    '/api/v1/video/send': api_send_email,
    '/api/v1/email/read': api_read_email,
    '/api/v1/config/threshold': api_config_threshold,
    '/api/v1/config/teacher': api_config_teacher,
}
